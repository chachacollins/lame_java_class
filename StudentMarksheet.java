 ...
 * * This program demonstrates the pure sequential use of Java variables, the Scanner class,
 * arithmetic operators, and formatted output (printf) to display a student
 * marksheet for 5 students without using loops, arrays, or decision statements.
 * */
public class StudentMarksheet {
    ...
    public static void main(String[] args) {
        ...
        // -------------------------------------------------------------------
        // --- 2. INPUT CAPTURE (5 Students) AND VARIABLE DECLARATION ---
        // -------------------------------------------------------------------

        System.out.println("Please enter data for 5 students (ensure all marks are whole numbers):");
        System.out.println("----------------------------------------------------------------------\n");

        // --- Student 1 (Group Member 1: Lewis Ngacha) ---
        ...
        System.out.println("\n\n*********************************************************************************");
        System.out.println("FINAL MARK SHEET DISPLAY");
        System.out.println("*********************************************************************************\n");

        // --- UPDATED FORMAT STRINGS ---
        // Column widths: RegNo(16), Name(25), Units(8*7), Totals(8), Average(10), Status(8), Grade(6)
        // I increased Reg No from 10 to 16 and Full Name from 20 to 25.
        ...
        // The separator line must also be adjusted to match the new widths.
